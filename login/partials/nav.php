    ...
    <ul class="nav navbar-nav navbar-right">
		<!--<li class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
				  <li><a href="<?php echo $this->base_url; ?>/chapter/"><i class="fas fa-tachometer-alt pr-1"></i> Nomination Dashboard</a></li>
			</ul>-->
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
				...
				<li><a href="<?php echo $this->base_url; ?>/admin/">Review Adult Nominations</a></li>
                ...
                <!-- Admin Controls -->
                <?php if ($auth->isAdmin()): ?>
                  <li><a href="<?php echo $this->base_url; ?>/admin/elections.php">Unit Elections</a></li>
