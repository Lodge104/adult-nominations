...
if (!$userInfo) : ?>
  ...
  <head>
    ...
    <title>Approve Nomination | Occoneechee Lodge - Order of the Arrow, BSA</title>
  ...
  <?php else : ?>
    ...
    <head>
      ...
      <title>Nomination Portal | Occoneechee Lodge - Order of the Arrow, BSA</title>
              ...
              ?>
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <form action="approve-nomination-process.php" method="post">
                      <div class="col-md-12">
                      ...
                      <div class="form-row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea id="training" name="training" rows="2" class="form-control" disabled><?php echo $getUnitElections['training']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="position_held" class="required">Positions Held</label>
                            <textarea id="position_held" name="position_held" rows="2" class="form-control" disabled><?php echo $getUnitElections['position_held']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="youth_rank">Rank as a Youth Scout</label>
                            <input id="youth_rank" name="youth_rank" type="text" class="form-control" value="<?php echo $getUnitElections['youth_rank']; ?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="community_activities" class="required">Community Activities</label>
                            <textarea id="community_activities" name="community_activities" rows="2" class="form-control" disabled><?php echo $getUnitElections['community_activities']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="employment" class="required">Employment/Trade</label>
                            <textarea id="employment" name="employment" rows="2" class="form-control" disabled><?php echo $getUnitElections['employment']; ?></textarea>
                          </div>
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="form-row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea id="short_term" name="short_term" rows="2" class="form-control" disabled><?php echo $getUnitElections['short_term']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="long_term" class="required">Long Term Camping</label>
                            <textarea id="long_term" name="long_term" rows="2" class="form-control" disabled><?php echo $getUnitElections['long_term']; ?></textarea>
                          </div>
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="form-row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="abilities" name="abilities" rows="4" class="form-control" disabled><?php echo $getUnitElections['abilities']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="purpose" name="purpose" rows="4" class="form-control" disabled><?php echo $getUnitElections['purpose']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea id="role_modal" name="role_modal" rows="4" class="form-control" disabled><?php echo $getUnitElections['role_modal']; ?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="form-row justify-content-center">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="advisor_signature" class="required">Approve or Disapprove</label>
                            <select id="advisor_signature" name="advisor_signature" class="custom-select" required>
                              <option></option>
                              <option value="1" <?php echo ($getUnitElections['advisor_signature'] == '1' ? 'selected' : ''); ?>>Approve</option>
                              <option value="2" <?php echo ($getUnitElections['advisor_signature'] == '2' ? 'selected' : ''); ?>>Disapprove</option>
                            </select>
                          </div>
                        </div>
                      </div>
